...
Garantiza que un release interrumpido por un crash pueda recuperarse de forma consistente: qué persiste el checkpoint en cada fase, cómo el resume evita reintentar pasos ya aplicados (commit, tags, reorder), y qué restaura exactamente el rollback (package.json, CHANGELOG, commit de release, tags y commits reordenados).
