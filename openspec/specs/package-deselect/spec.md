...
Permite al usuario quitar uno o más paquetes del release planificado desde la pantalla de resumen post-scan (`showScanSummaryPrompt`), sin necesidad de abortar el wizard ni re-ejecutar la selección de commits.
